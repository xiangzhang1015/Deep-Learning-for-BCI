...
| **Brain Signals**         |                              | **Name **                    | **\# Sub**  | **\# Cla**  | **S-Rate**  | **\# Channel**                                       | **Download Link** |
| :------------------------ | :--------------------------- | :--------------------------- | :---------- | :---------- | :---------- | :--------------------------------------------------- | :--- |
| **Inva-** <br> ** sive**  | **FM EcoG**                  | BCI-C IV, Data set IV        | 3           | 5           | 1000        | 48 -- 64                                             | [link](http://www.bbci.de/competition/iv/)  |
|                           | **MI EcoG**                  | BCI-C III  <br>  Data set I  | 1           | 2           | 1000        | 64                                                   | Link |
| **EEG**                   | **Sleeping ** <br> ** EEG**  | Sleep-EDF Telemetry          | 22          | 6           | 100         | 2 EEG, 1 EOG, 1 EMG                                  | Link |
|                           |                              | Sleep-EDF: Cassette          | 78          | 6           | 100, 1      | 2 EEG (100 Hz), 1 EOG (100 Hz),  <br>  1 EMG (1 Hz)  | Link |
|                           |                              | MASS-1                       | 53          | 5           | 256         | 17/19 EEG, 2 EOG, 5 EMG                              | Link |
|                           |                              | MASS-2                       | 19          | 6           | 256         | 19 EEG, 4 EOG, 1EMG                                  | Link |
|                           |                              | MASS-3                       | 62          | 5           | 256         | 20 EEG, 2 EOG, 3 EMG                                 | Link |
|                           |                              | MASS-4                       | 40          | 6           | 256         | 4 EEG, 4 EOG, 1 EMG                                  | Link |
|                           |                              | MASS-5                       | 26          | 6           | 256         | 20 EEG, 2 EOG, 3 EMG                                 | Link |
|                           |                              | SHHS                         | 5804        | N/A         | 125, 50     | 2 EEG (125 Hz), 1EOG (50 Hz),  <br>  1 EMG (125 Hz)  | Link |
|                           | **Seizure ** <br> ** EEG**   | CHB-MIT                      | 22          | 2           | 256         | 18                                                   | Link |
|                           |                              | TUH                          | 315         | 2           | 200         | 19                                                   | Link |
|                           | **MI ** <br> ** EEG**        | EEGMMI                       | 109         | 4           | 160         | 64                                                   | Link |
|                           |                              | BCI-C II, Data set III       | 1           | 2           | 128         | 3                                                    | Link |
|                           |                              | BCI-C III, Data set III a    | 3           | 4           | 250         | 60                                                   |      |
|                           |                              | BCI-C III, Data set III b    | 3           | 2           | 125         | 2                                                    |      |
|                           |                              | BCI-C III, Data set IV a     | 5           | 2           | 1000        | 118                                                  |      |
|                           |                              | BCI-C III, Data set IV b     | 1           | 2           | 1001        | 119                                                  |      |
|                           |                              | BCI-C III, Data set IV c     | 1           | 2           | 1002        | 120                                                  |      |
|                           |                              | BCI-C IV, Data set I         | 7           | 2           | 1000        | 64                                                   |      |
|                           |                              | BCI-C IV, Data set II a      | 9           | 4           | 250         | 22 EEG, 3 EOG                                        |      |
|                           |                              | BCI-C IV, Data set II b      | 9           | 2           | 250         | 3 EEG, 3 EOG                                         |      |
|                           | **Emotional** <br> ** EEG**  | AMIGOS                       | 40          | 4           | 128         | 14                                                   |      |
|                           |                              | SEED                         | 15          | 3           | 200         | 62                                                   |      |
|                           |                              | DEAP                         | 32          | 4           | 512         | 32                                                   |      |
|                           | **Others ** <br> ** EEG**    | Open MIIR                    | 10          | 12          | 512         | 64                                                   |      |
|                           | **VEP**                      | BCI-C II, Data set II b      | 1           | 36          | 240         | 64                                                   |      |
|                           |                              | BCI-C III, Data set II       | 2           | 26          | 240         | 64                                                   |      |
